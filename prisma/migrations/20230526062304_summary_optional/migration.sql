...
CREATE TABLE "Metric" (
    ...
    "publicTeam" BOOLEAN NOT NULL,
    "whitePaper" BOOLEAN NOT NULL,
    "lastUpdated" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "Coin" ADD CONSTRAINT "Coin_metricId_fkey" FOREIGN KEY ("metricId") REFERENCES "Metric"("id") ON DELETE SET NULL ON UPDATE CASCADE;
